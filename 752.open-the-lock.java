    ...
    public int openLock(String[] deadends, String target) {
        ...
        while (!queue.isEmpty()) {
            ...
            while (size > 0) {
                ...
                for (int i = 0; i < 4; i++) {
                    char c = sb.charAt(i);
                    String l1 = sb.substring(0, i) + (c == '0' ? 9 : c - '0' - 1) + sb.substring(i + 1);
                    String l2 = sb.substring(0, i) + (c == '9' ? 0 : c - '0' + 1) + sb.substring(i + 1);

                    if (!deadendSet.contains(l1)) {
                        queue.offer(l1);
                    }

                    if (!deadendSet.contains(l2)) {
                        queue.offer(l2);
                    }
                }
            }
